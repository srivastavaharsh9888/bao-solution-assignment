"""
Django settings for baomovie project.
...
SECRET_KEY = 'django-insecure-j1$r63c=-96&e-een(_awo4e9*gdixt#d0qqvsg+an6-$8f-q)'
...
WSGI_APPLICATION = 'baomovie.wsgi.application'
